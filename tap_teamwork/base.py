...
import pytz
import singer
import tap_teamwork.cache as stream_cache

from datetime import timedelta, datetime

from tap_teamwork.config import get_config_start_date
from tap_teamwork.state import incorporate, save_state, get_last_record_value_for_table
...
class BaseStream:
    ...
    def sync_paginated(self, url, params):
        ...
        all_resources = []
        # teamwork returns an array of data, without pagination metadata
